...
//==============================================================================
LaF_demoAudioProcessor::LaF_demoAudioProcessor()
                       ...
                       ),m_algo(this), m_parameterVTS(nullptr)
{
    ...
    m_parameterVTS = std::make_unique<AudioProcessorValueTreeState>(*this, nullptr, Identifier("LaF_demoVTS"),
...
//==============================================================================
const juce::String LaF_demoAudioProcessor::getName() const
{
    return JucePlugin_Name;
}

bool LaF_demoAudioProcessor::acceptsMidi() const
{
...
bool LaF_demoAudioProcessor::producesMidi() const
{
...
bool LaF_demoAudioProcessor::isMidiEffect() const
{
   #if JucePlugin_IsMidiEffect
    return true;
   #else
...
double LaF_demoAudioProcessor::getTailLengthSeconds() const
{

    return 0.0;
}

int LaF_demoAudioProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
                // so this should be at least 1, even if you're not really implementing programs.
}

int LaF_demoAudioProcessor::getCurrentProgram()
{
    return 0;
}

void LaF_demoAudioProcessor::setCurrentProgram (int index)
{
    juce::ignoreUnused (index);
}

const juce::String LaF_demoAudioProcessor::getProgramName (int index)
{
    juce::ignoreUnused (index);
    return {};
}

void LaF_demoAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
    juce::ignoreUnused (index, newName);
}

//==============================================================================
void LaF_demoAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
...
void LaF_demoAudioProcessor::releaseResources()
{
    // When playback stops, you can use this as an opportunity to free up any
    // spare memory, etc.
}

bool LaF_demoAudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
  #if JucePlugin_IsMidiEffect
...
void LaF_demoAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer,
...
//==============================================================================
bool LaF_demoAudioProcessor::hasEditor() const
{
    return true; // (change this to false if you choose to not supply an editor)
}

juce::AudioProcessorEditor* LaF_demoAudioProcessor::createEditor()
{
    return new LaF_demoAudioProcessorEditor (*this);
}

//==============================================================================
void LaF_demoAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
...
void LaF_demoAudioProcessor::setStateInformation (const void* data, int sizeInBytes)
{
...
{
    return new LaF_demoAudioProcessor();
}
