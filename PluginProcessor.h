...
//==============================================================================
class LaF_demoAudioProcessor  : public juce::AudioProcessor
{
public:
    friend class LaF_demoAudioProcessorEditor;
    //==============================================================================
    LaF_demoAudioProcessor();
    ~LaF_demoAudioProcessor() override;
...
private:
    ...
    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (LaF_demoAudioProcessor)
};
